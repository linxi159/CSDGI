...
class SVM(object):
    ...
    def Run(self):
        ...
        testSet = []
        split = 0.7
        self.loadDataset(r'GSE76312_Single_cell_HSCs_expression_RPKM_table_gene_filtering_log_normal232tumor902_deg_normal_tumor_top2.csv', split, trainingSet, testSet)   #数据划分
...
if __name__ == '__main__':
    ...
    file_name_data1 = './Accuracy_top20-1_svm/Accuracy_top2_100_times_svm.csv'
    file_name_data2 = './F1_top20-1_svm/F1_top2_100_times_svm.csv'
    ...
    print('Ave_accuracy_top20_100_times_svm: ' + repr(accuracy_data) + '%')
    ...
    print('Ave_f1_top20_100_times_svm: ' + repr(f1_data) + '%')
