...
if __name__ == '__main__':
    ...
    filename   = './data/GSE75688_GEO_processed_Breast_Cancer_raw_TPM_matrix_gene_filtering_log_tumor317_deg.csv'
    ...
    if args.train == True:
        ...
        np.savetxt('./result_n2/feature_weight_n2_without_label.csv', fea_weight, delimiter = ',')
        np.savetxt('./result_n2/labels_predict_n2_without_label.csv', labels_predict_, delimiter = ',')
