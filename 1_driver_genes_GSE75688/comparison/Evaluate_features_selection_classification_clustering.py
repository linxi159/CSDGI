...
class FS_cla(object):
    ...
    def loadDataset(self,filename, data, target):  # 加载数据集  split以某个值为界限分类train和test
        with open(filename, 'r') as csvfile:
            ...
            dat = np.array(dat)
            data, target = np.split(dat, (820, ), axis=1)            
            data[data == ''] = 0.0
    ...
    def Run(self):
        ...
        data = []
        target = []
        data, target = self.loadDataset(r'GSE75688_GEO_processed_Breast_Cancer_raw_TPM_matrix_gene_filtering_log_nontumor198tumor317_deg820.csv', data, target)   #数据划分
...
if __name__ == '__main__':
    ...
    for i in range(2,21,2):
        ...
        print('Ave_Ari_chi2_f%s_kmeans_100_times: ' %(i) + repr(accuracy_data))
    ...
    file_name_data1 = 'Ave_Ari_chi2_f1-20_kmeans_100_times.csv'
    file_name_data2 = 'Var_Ari_chi2_f1-20_kmeans_100_times.csv'
    file_name_data3 = 'Std_Ari_chi2_f1-20_kmeans_100_times.csv'
